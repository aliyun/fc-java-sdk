 ...
 * TODO: add javadoc
 */
public class DeleteVpcBindingRequest extends HttpRequest {
    ...
    public DeleteVpcBindingRequest setServiceName(String serviceName) {
        this.serviceName = serviceName;
        return this;
    }

    public DeleteVpcBindingRequest setVpcId(String vpcId) {
        this.vpcId = vpcId;
        return this;
    }
    ...
    public Class<DeleteVpcBindingResponse> getResponseClass() {
        return DeleteVpcBindingResponse.class;
    }
}
