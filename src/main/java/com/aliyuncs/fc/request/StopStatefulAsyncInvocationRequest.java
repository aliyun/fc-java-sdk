...
public class StopStatefulAsyncInvocationRequest extends HttpRequest {
    ...
    public StopStatefulAsyncInvocationRequest(String serviceName, String qualifier, String functionName, String invocationId) {
