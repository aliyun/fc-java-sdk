...
public class GetProvisionConfigRequest extends HttpRequest {
    ...
    public String getPath() {
        return String
                .format(Const.SINGLE_PROVISION_CONFIG_PATH, Const.API_VERSION, this.serviceName, this.qualifier, this.functionName);
    }
