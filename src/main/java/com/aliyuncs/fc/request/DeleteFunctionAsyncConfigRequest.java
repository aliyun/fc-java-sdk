 ...
 * TODO: add javadoc
 */
public class DeleteFunctionAsyncConfigRequest extends HttpRequest {

    private final String serviceName;
    private final String functionName;
    private transient String qualifier;

    public DeleteFunctionAsyncConfigRequest(String serviceName, String qualifier, String functionName) {
    ...
    public Class<DeleteFunctionAsyncConfigResponse> getResponseClass() {
        return DeleteFunctionAsyncConfigResponse.class;
    }
