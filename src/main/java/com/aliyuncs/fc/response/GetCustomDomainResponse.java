...
public class GetCustomDomainResponse extends HttpResponse {
    private CustomDomainMetaData customDomainMetaData;

    public GetCustomDomainResponse setCustomDomainMetadata(CustomDomainMetaData customDomainMetaData) {
