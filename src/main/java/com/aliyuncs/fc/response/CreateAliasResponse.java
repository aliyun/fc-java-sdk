...
public class CreateAliasResponse extends HttpResponse {

    private AliasMetaData aliasMetaData;

    public CreateAliasResponse(AliasMetaData aliasMetaData) {
    ...
    public CreateAliasResponse setAliasMetaData(AliasMetaData aliasMetaData) {
        this.aliasMetaData = aliasMetaData;
        return this;
    }
