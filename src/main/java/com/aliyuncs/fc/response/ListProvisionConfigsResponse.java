...
public class ListProvisionConfigsResponse extends HttpResponse {
    ...
    public ListProvisionConfigsResponse setProvisionConfigs(ProvisionConfig[] provisionConfigs) {
    ...
    public ListProvisionConfigsResponse setNextToken(String nextToken) {
